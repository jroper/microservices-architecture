...
public class AuctionToStart {
    ...
    @JsonCreator
    public AuctionToStart(UUID itemId, UUID creator, int reservePrice, int increment, Instant startTime, Instant endTime) {
        this.itemId = itemId;
    ...
    public boolean equals(Object o) {
        ...
        AuctionToStart auction = (AuctionToStart) o;
